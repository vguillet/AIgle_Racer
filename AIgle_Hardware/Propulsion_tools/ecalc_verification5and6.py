...
#inchlist = ['5 inch','6 inch']
inchlist = ['5 inch']
exceldocs_list = ['ECALC_test5in.xlsx','ECALC_test6in.xlsx']
VERI_MAIN_DCT = {}
CONFIGS_MAIN_DCT = {}
for i in range(0,len(inchlist)):
    inchtype = inchlist[i] 
    if inchtype == '6 inch':
        # for 6 inch
        ...
        print('ERROR')
        break
    exceldoc = exceldocs_list[i]
    CONFIGS_MAIN_DCT[inchtype] = DUOS_main
    ...
    veri_data = pd.read_excel(exceldoc, header = 3, nrows= 93)         # Import Excel File with all the data
    ...
    VERI_MAIN_DCT[inchtype] = VERI_results_dct
    print('DONE with',inchtype)
